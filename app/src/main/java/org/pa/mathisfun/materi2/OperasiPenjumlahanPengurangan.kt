...
class OperasiPenjumlahanPengurangan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_operasi_perkalian_pembagian)
    ...
    private fun getMateriData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("OperasiPenjumlahanPengurangan")
