...
import org.pa.mathisfun.databinding.ActivityMateri11Binding
import org.pa.mathisfun.materi1.*
import org.pa.mathisfun.menu.HalamanPilihKelas

class Materi11 : AppCompatActivity() {

    private lateinit var binding: ActivityMateri11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMateri11Binding.inflate(layoutInflater)
    ...
    private fun nextMateri() {
        val statusBangunDatarKelas2 = "sudah"
...
//                Toast.makeText(this, "Lanjut Materi", Toast.LENGTH_SHORT).show()
                ...
                b.setTitle("Kelas 2 Selesai")
                b.setMessage("Kamu berhasil menyeselaikan pembelajaran matematika kelas 2. Ayo lanjut ke kelas selanjutnya")
