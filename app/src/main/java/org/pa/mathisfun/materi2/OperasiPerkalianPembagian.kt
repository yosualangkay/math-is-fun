...
class OperasiPerkalianPembagian : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_operasi_penjumlahan_pengurangan)
    ...
    private fun getMateriData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("OperasiPerkalianPembagian")
