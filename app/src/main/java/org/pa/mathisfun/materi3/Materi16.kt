...
import org.pa.mathisfun.databinding.ActivityMateri16Binding
import org.pa.mathisfun.databinding.ActivityMateri6Binding
import org.pa.mathisfun.menu.HalamanPilihKelas

class Materi16 : AppCompatActivity() {
    private lateinit var binding: ActivityMateri16Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMateri16Binding.inflate(layoutInflater)
    ...
    private fun nextMateri() {
        val statusKelilingLuasPersegi = "sudah"
...
//                Toast.makeText(this, "Lanjut Materi", Toast.LENGTH_SHORT).show()
                ...
                b.setTitle("Kelas 3 Selesai")
                b.setMessage("Kamu berhasil menyeselaikan pembelajaran matematika kelas 3. Ayo lanjut ke kelas selanjutnya")
