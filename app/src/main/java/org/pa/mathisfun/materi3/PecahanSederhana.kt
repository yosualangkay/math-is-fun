...
class PecahanSederhana : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pecahan_sederhana)
    ...
    private fun getMateriData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("PecahanSederhana")
