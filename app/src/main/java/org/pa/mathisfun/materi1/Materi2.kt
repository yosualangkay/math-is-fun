...
import org.pa.mathisfun.databinding.ActivityMateri2Binding
...
class Materi2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.youTubePlayerView1.addFullScreenListener(object : YouTubePlayerFullScreenListener {
            override fun onYouTubePlayerEnterFullScreen() {
        ...
        binding.youTubePlayerView2.addFullScreenListener(object : YouTubePlayerFullScreenListener {
            override fun onYouTubePlayerEnterFullScreen() {
        ...
        binding.youTubePlayerView3.addFullScreenListener(object : YouTubePlayerFullScreenListener {
            override fun onYouTubePlayerEnterFullScreen() {
    ...
    private fun nextMateri() {
        val statusSatuanPengukuran = "sudah"
