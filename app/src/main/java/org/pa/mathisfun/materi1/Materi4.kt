...
import org.pa.mathisfun.databinding.ActivityMateri4Binding
import org.pa.mathisfun.menu.HalamanPilihKelas

class Materi4 : AppCompatActivity() {

    private lateinit var binding: ActivityMateri4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMateri4Binding.inflate(layoutInflater)
    ...
    private fun nextMateri() {
        val statusPenjumlahanPengurangan = "sudah"
