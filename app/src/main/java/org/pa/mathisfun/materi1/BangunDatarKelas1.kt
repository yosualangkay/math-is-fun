...
class BangunDatarKelas1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bangun_datar_kelas1)
    ...
    private fun getMateriData() {
        ...
        dbref = FirebaseDatabase.getInstance().getReference("BangunDatarKelas1")
