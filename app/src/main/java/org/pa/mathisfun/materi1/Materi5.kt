...
import org.pa.mathisfun.databinding.ActivityMateri5Binding
import org.pa.mathisfun.menu.HalamanPilihKelas

class Materi5 : AppCompatActivity() {

    private lateinit var binding: ActivityMateri5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMateri5Binding.inflate(layoutInflater)
    ...
    private fun nextMateri() {
        val statusPengukuranBerat = "sudah"
